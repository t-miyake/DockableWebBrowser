...
namespace DockableWebBrowser
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class Dockable_Web_BrowserCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("f2215ad3-b24a-41a6-8912-235d7574de28");
        ...
        /// </summary>
        public static Dockable_Web_BrowserCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new Dockable_Web_BrowserCommand(package);
        }
